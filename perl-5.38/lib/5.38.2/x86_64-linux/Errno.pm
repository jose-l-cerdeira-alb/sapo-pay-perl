...
"x86_64-linux-5.15.0-91-generic" or
	die "Errno architecture (x86_64-linux-5.15.0-91-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
